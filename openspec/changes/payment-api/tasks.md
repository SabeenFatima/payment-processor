...
- [ ] 1.1 Create PaymentRequest.java in dto package with amount, currency, description fields
- [ ] 1.2 Add @NotNull validation on amount and currency fields
- [ ] 1.3 Add @Positive validation on amount field
